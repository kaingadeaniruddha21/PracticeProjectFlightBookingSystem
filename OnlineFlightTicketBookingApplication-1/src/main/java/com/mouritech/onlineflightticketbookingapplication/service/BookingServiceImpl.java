...
public class BookingServiceImpl implements BookingService{
	...
	@Override
	public ResponseEntity<List<Booking>> getAllBookingByUserId(Long userId) throws UserNotFoundException {
...
//	@Override
//	public ResponseEntity<Booking> createBooking(Long userId, Long passengerId,Booking newBooking) throws UserNotFoundException {
//	
