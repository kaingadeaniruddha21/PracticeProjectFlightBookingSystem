...
public class FlightServiceImpl  implements FlightService{
	...
	@Override
	public ResponseEntity<List<Flight>> getAllFlightsByLocationId(Long locationId) throws LocationNotFoundException {
		if(!locationRepository.existsById(locationId)) {
			throw new LocationNotFoundException("location not found with id " + locationId);
		}
		List<Flight> flight = flightRepository.findByLocation_LocationId(locationId);
