...
public interface FlightService {
	...
	ResponseEntity<List<Flight>> getAllFlightsByLocationId(Long locationId) throws LocationNotFoundException;

	ResponseEntity<Flight> createFlight(Long locationId, Flight newFlight) throws LocationNotFoundException;


	
//	ResponseEntity<Flight>  findByFlightDepartureLocAndArrivalLoc(String departureLoc, String arrivalLoc) throws FlightNotFoundException;
